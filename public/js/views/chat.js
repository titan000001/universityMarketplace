...
const chatView = () => `
    <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden flex flex-col h-[600px] transition-colors duration-200">
        ...
        <form id="chat-form" class="p-4 bg-white dark:bg-gray-800 flex gap-2">
            <input type="text" id="message-input" class="flex-1 px-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Type a message..." required autocomplete="off" aria-label="Type a message" autofocus>

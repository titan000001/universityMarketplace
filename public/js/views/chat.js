...
const chatView = () => `
    <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden flex flex-col h-[600px] transition-colors duration-200">
        ...
        <form id="chat-form" class="p-4 bg-white dark:bg-gray-800 flex gap-2">
            <input type="text" id="message-input" class="flex-1 px-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Type a message..." aria-label="Message to send" required autocomplete="off">
            <button type="submit" aria-label="Send message" class="bg-indigo-600 text-white px-6 py-2 rounded-full hover:bg-indigo-700 transition-colors">

        ...
        <form id="login-form">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <button type="button" id="toggle-password" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-600 dark:text-gray-400 hover:text-indigo-600 focus:outline-none" aria-label="Show password">
